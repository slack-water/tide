...
- Makefile with lint, validate, links, spell, and check targets
- Frontmatter validation script (scripts/validate-frontmatter.py)
- GitHub Actions: CI on PRs (lint + validate), link check on merge
- PR template, markdownlint config, link-check config
- LICENSE (CC BY 4.0)
